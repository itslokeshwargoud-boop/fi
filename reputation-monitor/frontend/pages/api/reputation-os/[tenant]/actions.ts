/**
 * /api/reputation-os/[tenant]/actions — Powered by the unified Processing Layer.
 *
 * Generates risk-based action recommendations from real-time Talk + Feed data
...
import { recommendActions } from "@/lib/reputationEngine";
...
export default async function handler(
  req: NextApiRequest,
  res: NextApiResponse<ActionRecommendation[] | { error: string }>,
) {
  if (req.method !== "GET") {
