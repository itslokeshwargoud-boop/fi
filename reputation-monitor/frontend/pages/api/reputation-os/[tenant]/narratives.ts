/**
 * /api/reputation-os/[tenant]/narratives — Powered by the unified Processing Layer.
 *
 * Clusters discussion topics from Talk comment data using keyword analysis
...
export default async function handler(
  req: NextApiRequest,
  res: NextApiResponse<NarrativeCluster[] | { error: string }>,
) {
  if (req.method !== "GET") {
