/**
 * /api/reputation-os/[tenant]/alerts — Powered by the unified Processing Layer.
 *
 * Generates alerts from real-time Talk + Feed data (sentiment spikes,
 * bot activity, velocity surges) instead of proxying to a separate backend.
 */
...
export default async function handler(
  req: NextApiRequest,
  res: NextApiResponse<Alert[] | { error: string }>,
) {
  if (req.method !== "GET") {
