/**
 * /api/reputation-os/[tenant]/predictions — Powered by the unified Processing Layer.
 *
 * Forecasts reputation trends from historical Talk + Feed patterns
...
import { predictTrends } from "@/lib/reputationEngine";
...
export default async function handler(
  req: NextApiRequest,
  res: NextApiResponse<PredictionsReport | { error: string }>,
) {
  if (req.method !== "GET") {
